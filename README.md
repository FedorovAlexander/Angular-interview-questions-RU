...
<details>
	...
	6. <a href="answers/API.md#templateref">How would you insert an embedded view from a prepared TemplateRef?</a> <br/>
	7. <a href="answers/API.md#difference">What is the difference between @ViewChild() and @ContentChild()</a>
</details>
