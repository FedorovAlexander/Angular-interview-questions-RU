...
## <a name="providers"></a>Как зарегистрировать сервис в providers?

Чтобы зарегистрировать сервис в providers, нужно использовать декоратор `@Injectable` и указать свойство `providedIn`.
...
## <a name="use-in-component"></a>Как использовать сервис в компоненте?

Чтобы использовать сервис в компоненте, нужно инжектировать его в конструктор компонента.
